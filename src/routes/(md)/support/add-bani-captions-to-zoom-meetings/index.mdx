...
import zoomSettingsClosedCaptioning from '/media/zoom-settings-closed-captioning.png'
import zoomMeetingControlsClosedCaption from '/media/zoom-meeting-controls-closed-caption.png'
import shabadosZoomPanel from '/media/shabados-zoom-panel.png'
...
<Media src={zoomSettingsClosedCaptioning} alt='' />
...
<Media src={zoomMeetingControlsClosedCaption} alt='' />
...
<Media src={shabadosZoomPanel} alt='' />
