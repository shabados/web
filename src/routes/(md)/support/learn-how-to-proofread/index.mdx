...
import differenceBrowser from '/media/proofreading-difference-example-browser.png'
import differencePdf from '/media/proofreading-difference-example-pdf.png'
import submitTicket from '/media/proofreading-difference-submit-proofreading-ticket.png'
import copySnipAndSketch from '/media/proofreading-example-copy-snip-and-sketch.png'
import insertCursorGhIssue from '/media/proofreading-example-insert-cursor-gh-issue.png'
import pasteImageGhIssue from '/media/proofreading-example-paste-image-gh-issue.png'
...
4. In the GitHub issue, click the last empty line in the textbox (after the words ​**Add details & attach image(s) below**), so that the blinking text cursor is at the very end.
   ...
   <Media src={insertCursorGhIssue} alt='Image of github issue template' />

5. Paste the screenshot.

   <Media src={pasteImageGhIssue} alt='Image of pasting into github issue' />
