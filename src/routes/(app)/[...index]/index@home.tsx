      ...
      <div class='hero'>
        <div>
          <article>
            ...
            <p class='search-tip' ref={searchTipRef}>
          ...
          <div class='short-list' ref={shortListRef}>
            <div class='carousel'>
              <div class='cards'>
                <a class='card' href='/b/jap-ji-sahib'>
                  <p>ਜਪੁ ਜੀ ਸਾਹਿਬ</p>
                </a>
                <a class='card' href='/b/rehras-sahib'>
                  <p>ਰਹਰਾਸਿ ਸਾਹਿਬ</p>
                </a>
                <a class='card' href='/b/kirtan-sohila'>
                  <p>ਕੀਰਤਨ ਸੋਹਿਲਾ</p>
                </a>
                <a class='card' href='/b/ardas'>
                  <p>ਅਰਦਾਸ</p>
                </a>
                <a
                  class='card'
                  href='#'
                  onClick$={() => {
                    searchTipRef.value!.style.display = 'none';
            ...
            <div>
              <div class='carousel'>
                <div class='cards'>
                  ...
                  <a class='card' href='/b/jap-sahib'>
                    <p>ਜਾਪੁ ਸਾਹਿਬ</p>
                  </a>
                  <a class='card' href='/b/twa-prasad-swaye'>
                    <p>ਤ੍ਵ ਪ੍ਰਸਾਦਿ - ਸ੍ਵਯੇ</p>
                  </a>
                  <a class='card' href='/b/kabyo-bac-benti-copai'>
                    <p>ਕਬ︀︁ਯੋ ਬਾਚ ਬੇਨਤੀ - ਚੌਪਈ</p>
                  </a>
                  <a class='card' href='/b/anand-sahib'>
                    <p>ਅਨੰਦੁ ਸਾਹਿਬ</p>
                  </a>
                </div>
              </div>
            ...
            <div>
              <div class='carousel'>
                <div class='cards'>
                  ...
                  <a class='card' href='/b//asa-ki-var/1'>
                    <p>ਛੱਕਾ ੧</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/2'>
                    <p>ਛੱਕਾ ੨</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/3'>
                    <p>ਛੱਕਾ ੩</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/4'>
                    <p>ਛੱਕਾ ੪</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/5'>
                    <p>ਛੱਕਾ ੫</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/6'>
                    <p>ਛੱਕਾ ੬</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/7'>
                    <p>ਛੱਕਾ ੭</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/8'>
                    <p>ਛੱਕਾ ੮</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/9'>
                    <p>ਛੱਕਾ ੯</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/10'>
                    <p>ਛੱਕਾ ੧੦</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/11'>
                    <p>ਛੱਕਾ ੧੧</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/12'>
                    <p>ਛੱਕਾ ੧੨</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/13'>
                    <p>ਛੱਕਾ ੧੩</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/14'>
                    <p>ਛੱਕਾ ੧੪</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/15'>
                    <p>ਛੱਕਾ ੧੫</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/16'>
                    <p>ਛੱਕਾ ੧੬</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/17'>
                    <p>ਛੱਕਾ ੧੭</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/18'>
                    <p>ਛੱਕਾ ੧੮</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/19'>
                    <p>ਛੱਕਾ ੧੯</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/20'>
                    <p>ਛੱਕਾ ੨੦</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/21'>
                    <p>ਛੱਕਾ ੨੧</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/22'>
                    <p>ਛੱਕਾ ੨੨</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/23'>
                    <p>ਛੱਕਾ ੨੩</p>
                  </a>
                  <a class='card' href='/b//asa-ki-var/24'>
                    <p>ਛੱਕਾ ੨੪</p>
                  </a>
                </div>
              </div>
